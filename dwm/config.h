...
static const char *fonts[]          = { "Hack:size=10.5:antialias=true:autohint=true" };
static const char dmenufont[]       = { "Hack:size=10.5:antialias=true:autohint=true" };
static const char col_gray1[]       = "#020a0e";
static const char col_gray2[]       = "#2c2e2d";
static const char col_gray3[]       = "#b5b7b8";
static const char col_gray4[]       = "#020a0e"; //0a0f14
static const char col_cyan[]        = "#b5b7b8";
